    ...
    <>
      <div className="relative rounded-2xl w-[90%] mt-3 mx-auto flex flex-col-reverse lg:flex-row gap-6 items-center justify-between">
        <div className="flex flex-col px-1 items-center md:items-start">
          ...
          <p className="mt-4 text-gray-400 text-left text-[15px] sm:text-[18px]">BNB Sidechain is an infrastructure
      ...
      <div className="flex p-5 pt-8 md:pt-3 gap-4 md:flex-row flex-col text-left items-start justify-between md:px-[6%]">
